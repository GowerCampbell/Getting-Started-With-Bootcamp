Here’s a comprehensive `git-basics.md` file that explains the fundamentals of Git. This guide is designed to help beginners like me understand and use Git effectively.
